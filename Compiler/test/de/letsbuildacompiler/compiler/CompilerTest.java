...
public class CompilerTest {
	...
	public Object[][] provide_code_expectedText() {
		return new Object[][]{
				...
				{"int methodWithParams(int a) {\n" + 
						"  int x;\n" + 
						"  x = a;\n" + 
						"  return x;\n" + 
						"}\n" + 
						"println(methodWithParams(5));",
				...
				{"int assignToVector(int a) {\n" + 
						"  int x[3];\n" +
						"  x[0] = a;\n" +
						"  return x[0];\n" +
						"}\n" +
						"println(assignToVector(10));",
						"10" + System.lineSeparator()},
				{"int vectorIndex(int index) {\n" + 
						"  int x[10];\n" +
						"  x[index] = index;\n" +
						"  return x[index];\n" +
						"}\n" +
						"println(vectorIndex(2));",
						"2" + System.lineSeparator()},
				{"int PA(int a) {\n" + 
						"  int x[4];\n" +
						"  x[0] = a;\n" +
				...
				{"int simpleWhile() {\n" + 
						...
						" return i;\n" +
						"}\n" + 
						"println(simpleWhile());", "10" + System.lineSeparator()},
				{"int whileALessThanB(int a, int b) {\n" + 
						"  while (a < b) {\n" + 
						"  		a = a + 1;\n" + 
						"	};\n" +
						" return a;\n" +
						"}\n" + 
						"println(whileALessThanB(1, 10));", "10" + System.lineSeparator()},
				{"int initArray() {\n" + 
						"  int i;\n" + 
						"  i = 0;\n" + 
						"  int vec[10];\n" + 
				...
				{"int simpleIfTrue() {\n" + 
						...
						" return i;\n" +
						"}\n" + 
						"println(simpleIfTrue());", "1" + System.lineSeparator()},
				{"int simpleIfFalse() {\n" + 
						"  int i;\n" + 
						"  i = 0;\n" + 
						"  if (i >= 10) {\n" + 
						...
						" return i;\n" +
						"}\n" + 
						"println(simpleIfFalse());", "0" + System.lineSeparator()},
				{"int simpleIfElse() {\n" + 
						"  int i;\n" + 
						"  i = 0;\n" + 
						"  if (i == 10) {\n" + 
						...
						" return i;\n" +
						"}\n" + 
						"println(simpleIfElse());", "200" + System.lineSeparator()},
				{"int inserir(int k, int x, int n, int v[]) {\n" +
					 ...
					 "v[3] = 40;\n" +
					 "v[4] = 50;\n" +
					 "println(inserir(2, 40, 5, v));", "6" + System.lineSeparator()},
				};
	}
